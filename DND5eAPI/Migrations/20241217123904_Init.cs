...
namespace DND5eAPI.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Tools",
                columns: new[] { "Id", "Actions", "Backgrounds", "Classes", "CraftableItems", "Equipment", "IndexName", "Name" },
                values: new object[,]
                {
                    { 1, "[{\"Name\":\"Identify a substance\",\"Attribute\":\"intelligence\",\"DC\":15},{\"Name\":\"Start a fire\",\"Attribute\":\"intelligence\",\"DC\":15}]", null, null, "[]", null, "alchemists-supplies", "Alchemist's Supplies" },
                    { 2, "[{\"Name\":\"Create a map\",\"Attribute\":\"wisdom\",\"DC\":15}]", null, null, "[]", null, "cartographers-tools", "Cartographer's Tools" },
                    { 3, "[{\"Name\":\"Improve food\\u0027s flavor\",\"Attribute\":\"wisdom\",\"DC\":10},{\"Name\":\"Detect spoiled or poisoned food\",\"Attribute\":\"wisdom\",\"DC\":15}]", null, null, "[]", null, "cooks-utensils", "Cook's Utensils" },
                    { 4, "[{\"Name\":\"Mimic 10 or fewer words of someone else\\u2019s handwriting\",\"Attribute\":\"dexterity\",\"DC\":15},{\"Name\":\"Duplicate a wax seal\",\"Attribute\":\"dexterity\",\"DC\":20}]", null, null, "[]", null, "forgery-kit", "Forgery Kit" },
                    { 5, "[{\"Name\":\"Pick a lock\",\"Attribute\":\"dexterity\",\"DC\":15},{\"Name\":\"Disarm a trap\",\"Attribute\":\"dexterity\",\"DC\":15}]", null, null, "[]", null, "thieves-tools", "Thieves's Tools" },
                    { 6, "[{\"Name\":\"Write text with impressive flourishes that guard against forgery\",\"Attribute\":\"dexterity\",\"DC\":15}]", null, null, "[]", null, "calligraphers-supplies", "Calligrapher's Supplies" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Armors",
                columns: new[] { "Id", "ArmorTypeId", "BaseArmorClass", "Cost", "Description", "Effects", "IndexName", "Name", "Spells", "Traits", "Weight" },
                values: new object[] { 1, 1, 10, 1, "A Robe has vocational or ceremonial significance. Some events and locations admit only people wearing a Robe bearing certain colors or symbols.", null, "wizards-robes", "Wizards Robes", null, null, 4.0 });

            migrationBuilder.InsertData(
                table: "Equipment",
                columns: new[] { "Id", "Backgrounds", "Classes", "Cost", "Description", "Effects", "EquipmentCategoryId", "IndexName", "Name", "PlayerCharacterId", "Tools", "Weight" },
                values: new object[,]
                {
                    { 1, null, null, 50, "A book containing spells used by wizards.", null, 5, "spellbook", "Spellbook", null, null, 3 },
                    { 2, null, null, 1, "One sheet of Parchment can hold about 250 handwritten words.", null, 5, "parchment", "Parchment", null, null, 0 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Weapons",
                columns: new[] { "Id", "AttunementRequired", "Cost", "Description", "Effects", "IndexName", "MagicBonus", "Name", "Spells", "Traits", "WeaponTypeId", "Weight" },
                values: new object[] { 1, false, 2, "A simple wooden staff, often used by mages.", null, "quarterstaff", 0, "Quarterstaff", null, null, 8, 4.0 });
